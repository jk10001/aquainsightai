# filename: gasprod_timeseries_1.py
import pandas as pd
...
# Output base name
base = "gasprod_timeseries_1"
py_fname = os.path.basename(__file__) if '__file__' in globals() else "gasprod_timeseries_1.py"
csv_out = f"{base}.csv"
...
plot_df = df[['Date',
              'Digester 1 gas production (m3/day)',
              'Digester 2 gas production (m3/day)',
              'Digester 3 gas production (m3/day)']].copy()

plot_df.rename(columns={
    'Digester 1 gas production (m3/day)': 'Digester 1 gas production [m3/day]',
    'Digester 2 gas production (m3/day)': 'Digester 2 gas production [m3/day]',
    'Digester 3 gas production (m3/day)': 'Digester 3 gas production [m3/day]'
}, inplace=True)
...
fig.add_trace(go.Scatter(
    x=plot_df['Date'],
    y=plot_df['Digester 1 gas production [m3/day]'],
    mode='lines+markers',
    name='Digester 1',
...
fig.add_trace(go.Scatter(
    x=plot_df['Date'],
    y=plot_df['Digester 2 gas production [m3/day]'],
    mode='lines+markers',
    name='Digester 2',
...
fig.add_trace(go.Scatter(
    x=plot_df['Date'],
    y=plot_df['Digester 3 gas production [m3/day]'],
    mode='lines+markers',
    name='Digester 3',
...
fig.update_yaxes(title_text='Gas production [m³/day]', rangemode='tozero', zeroline=True)
