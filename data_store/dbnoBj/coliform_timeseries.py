# filename: coliform_timeseries.py
import pandas as pd
...
fig.update_layout(
    ...
    yaxis=dict(
        title='Coliform bacteria (number/100 ml)',
        showgrid=True,
        gridcolor='lightgrey',
        showline=True,
        linecolor='black',
...
html_file = "coliform_timeseries.html"
png_file = "coliform_timeseries.png"
