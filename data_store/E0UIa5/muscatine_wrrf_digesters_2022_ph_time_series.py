# filename: muscatine_wrrf_digesters_2022_ph_time_series.py
import pandas as pd
import plotly.graph_objects as go

file_name = "muscatine_wrrf_digesters_2022.xlsx"
base_name = "muscatine_wrrf_digesters_2022_ph_time_series"
...
required_cols = ["Year", "Month", "Day", "Dig1-pH", "Dig2-pH"]
...
plot_df = df.loc[:, ["Date", "Dig1-pH", "Dig2-pH"]].copy()
plot_df = plot_df.sort_values("Date").reset_index(drop=True)

# Save CSV with exactly requested columns
csv_df = plot_df.rename(columns={
    "Date": "Date [YYYY-MM-DD]",
    "Dig1-pH": "Digester 1 pH [s.u.]",
    "Dig2-pH": "Digester 2 pH [s.u.]",
})
...
# Reference band lines as legend items
x0 = plot_df["Date"].min()
x1 = plot_df["Date"].max()
...
print("Created file: muscatine_wrrf_digesters_2022_ph_time_series.py")