# filename: lrv_boxplots_by_plant_revision_v2.py
import pandas as pd
import numpy as np
...
# Increase box width for visibility
box_width = 0.6
...
for idx, microorganism in enumerate(indicators):
    ...
    for plant in plants_order:
        ...
        # Box plot without points and no legend entry (no markers plotted)
...
# Save outputs
base_filename = "lrv_boxplots_by_plant_revision_v2"
...
print(html_file)
print(png_file)
print("lrv_boxplots_by_plant_revision_v2.py")